            ...
            <div className="space-y-8">
              <div className="space-y-6">
                <div className="flex items-center space-x-3">
                  <Badge variant="outline" className="flex items-center px-4 py-2 text-sm font-medium border-blue-200 text-blue-700">
                    <i className="fa-solid fa-globe w-4 h-4 mr-2 mt-2"></i>
                    Quy Nhon, Vietnam
                  </Badge>
                  <Badge variant="outline" className="px-4 py-2 text-sm font-medium border-green-200 text-green-700">
                ...
                <p className="text-xl text-gray-600 leading-relaxed max-w-xl">
                  Chuyên gia thiết kế đồ họa và video editor tự do, tạo ra những sản phẩm sáng tạo có tính ứng dụng cao
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button variant="outline" size="lg" className="px-8 py-4 text-lg font-semibold border-2 bg-transparent">
