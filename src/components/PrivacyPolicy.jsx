  ...
  return (
    <div className="privacy-policy container" style={{ padding: '101px 20px', maxWidth: '960px', margin: '0 auto' }}>
      ...
      <ul>
        ...
        <li><strong>Website</strong> refers to unitrux, accessible from <a href="https://unitrux.com/" target="_blank" rel="noopener noreferrer">https://unitrux.com/</a>.</li>
      ...
      <ul>
        ...
        <li><strong>Customer Support Data</strong></li>
        <ul>
      ...
      <p>The Company may retain Personal Data beyond the periods stated above for different reasons:</p>
      <ul>
      ...
      <ul>
        <li>By email: <a href="mailto:info@unitrux.com">info@unitrux.com</a></li>
        <li>By visiting this page on our website: <a href="https://www.termsfeed.com/live/unitrux.com" target="_blank" rel="noopener noreferrer">unitrux.com</a></li>
      </ul>
      <p>
        Generated using <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" rel="noopener noreferrer">TermsFeed Privacy Policy Generator</a>
      </p>
