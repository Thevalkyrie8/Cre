        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              ...
              <span className="font-bold text-xl text-white">Creative Studio</span>
            </div>
            <div className="text-gray-400 text-center md:text-right">
              <p>&copy; 2024 Creative Studio. Graphic Designer & Video Editor tại Quy Nhon.</p>
              <p className="text-sm mt-1">Tạo ra những sản phẩm sáng tạo, chất lượng cao.</p>
            </div>
          </div>
        </div>
      </footer>
