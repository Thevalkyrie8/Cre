...
const normalizeArticle = (item, language) => {
  ...
  return {
    ...
    category: normalizeText(item.category || 'Business'), excerpt: excerpt.length === 180 ? `${excerpt}…` : excerpt,
