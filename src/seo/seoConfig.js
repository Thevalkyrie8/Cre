...
export const seoPages = {
  ...
  '/photography-video': {
    title: 'Dịch vụ Quay Video Quảng Cáo tại TP.HCM | Unitrux',
    description: 'Unitrux sản xuất video quảng cáo, video sản phẩm, TikTok/Reels và video doanh nghiệp tại TP.HCM — concept, quay, dựng, bàn giao đa nền tảng theo quy trình 8 bước.',
    ogImage: `${SITE_URL}${productionHeroVideo.thumbnail}`,
    heading: 'Dịch vụ quay video quảng cáo tại TP.HCM',
    summary: 'Unitrux là đơn vị sản xuất video quảng cáo tại TP.HCM cho doanh nghiệp cần nội dung video cho quảng cáo, website và mạng xã hội. Dịch vụ gồm quay video quảng cáo sản phẩm, video giới thiệu doanh nghiệp, TikTok/Reels/Shorts, video cửa hàng và video phỏng vấn — từ brief, concept, quay dựng đến bàn giao đa nền tảng.',
    bullets: [
      'Quay video quảng cáo sản phẩm',
      'Video giới thiệu doanh nghiệp',
      'Video TikTok / Reels / Shorts',
      'Video cửa hàng, showroom, spa, salon',
      'Video phỏng vấn nhân sự và khách hàng',
      'Video hướng dẫn và trải nghiệm sản phẩm',
    ],
    facts: [
      ['Dịch vụ', 'Sản xuất video quảng cáo'],
      ['Khu vực phục vụ', 'TP.HCM và các tỉnh lân cận'],
      ['Quy trình', '8 bước: brief → research → concept → script/shot list → pre-production → quay → hậu kỳ → bàn giao đa nền tảng'],
      ['Nền tảng bàn giao', 'Facebook, TikTok, YouTube, website, sàn thương mại điện tử'],
      ['Tỷ lệ khung hình', '9:16, 4:5, 1:1, 16:9'],
      ['Đơn vị thực hiện', 'Unitrux'],
    ],
    faqs: productionFaqs,
    type: 'Service',
  ...
  '/product-photography': {
    title: 'Dịch vụ Chụp ảnh Sản phẩm Chuyên nghiệp tại TP.HCM | Unitrux',
    description: 'Unitrux chụp ảnh sản phẩm nền trắng, concept, lifestyle và hình ảnh thương hiệu tại TP.HCM cho website, sàn TMĐT và mạng xã hội — theo một tiêu chuẩn hình ảnh nhất quán.',
    heading: 'Dịch vụ chụp ảnh sản phẩm chuyên nghiệp tại TP.HCM',
    summary: 'Unitrux là đơn vị chụp ảnh sản phẩm chuyên nghiệp tại TP.HCM cho doanh nghiệp cần hình ảnh cho website, sàn thương mại điện tử và mạng xã hội. Dịch vụ gồm ảnh sản phẩm nền trắng, ảnh concept quảng cáo, ảnh lifestyle, ảnh cùng người mẫu, ảnh chuẩn sàn thương mại điện tử và hình ảnh thương hiệu — chụp theo một tiêu chuẩn hình ảnh nhất quán và bàn giao đa tỷ lệ.',
    bullets: [
      'Ảnh sản phẩm nền trắng và nền đơn sắc',
      'Ảnh concept quảng cáo',
      'Ảnh lifestyle sản phẩm trong sử dụng thực tế',
      'Ảnh sản phẩm cùng người mẫu',
      'Ảnh chuẩn sàn thương mại điện tử',
      'Hình ảnh thương hiệu và ảnh không gian',
    ],
    facts: [
      ['Dịch vụ', 'Chụp ảnh sản phẩm và thương hiệu'],
      ['Khu vực phục vụ', 'TP.HCM và các tỉnh lân cận'],
      ['Địa điểm chụp', 'Studio, tại cửa hàng/showroom của khách, hoặc on-location'],
      ['Tỷ lệ ảnh bàn giao', '1:1, 4:5, 3:2, 16:9, 9:16 tùy kênh sử dụng'],
      ['Đơn vị thực hiện', 'Unitrux'],
    ],
  ...
  '/media-pricing': {
    title: 'Bảng giá Quay Video và Chụp ảnh tại TP.HCM | Unitrux',
    description: 'Bảng giá tham khảo quay video quảng cáo, video ngắn và chụp ảnh sản phẩm tại TP.HCM — 17 gói/8 nhóm, các yếu tố ảnh hưởng báo giá và cách gửi brief nhận giá chính xác.',
    heading: 'Bảng giá quay video và chụp ảnh tại TP.HCM',
    summary: 'Đây là bảng giá tham khảo để doanh nghiệp dự trù ngân sách quay video và chụp ảnh tại TP.HCM, không phải giá cố định. Giá chính thức phụ thuộc concept, số lượng sản phẩm, số video, thời lượng, số bối cảnh, studio, người mẫu, hậu kỳ và deadline. Gửi brief để Unitrux trả về báo giá tách rõ từng hạng mục.',
    bullets: [
      'Bảng giá chụp ảnh sản phẩm',
      'Bảng giá chụp Food & Beverage',
      'Bảng giá chụp không gian, nội thất, dịch vụ',
      'Bảng giá ảnh thương hiệu và nhân sự',
      'Bảng giá video short-form (Reels / TikTok)',
      'Bảng giá video quảng cáo',
      'Bảng giá combo quay + chụp',
      'Bảng giá setup livestream / studio',
      'Yếu tố ảnh hưởng đến báo giá: thời lượng video và số lượng ảnh',
      'Yếu tố ảnh hưởng đến báo giá: địa điểm quay chụp và số bối cảnh',
      'Yếu tố ảnh hưởng đến báo giá: mức độ hậu kỳ và số vòng chỉnh sửa',
      'Yếu tố ảnh hưởng đến báo giá: thuê studio và thiết bị đặc thù',
      'Yếu tố ảnh hưởng đến báo giá: diễn viên, người mẫu, voice-over',
      'Yếu tố ảnh hưởng đến báo giá: số tỷ lệ khung hình xuất file và deadline',
    ],
    type: 'Service',
